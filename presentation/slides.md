...
<div class="flex flex-col gap-1 items-center justify-center mt-20">
  <img class="h-40 rounded" src="public/me.jpg"/>
  <div class="flex gap-8 items-center justify-center mt-4">
    <img class="h-12 rounded bg-white p-2" src="public/pwc.png"/>
    <img class="h-12 rounded bg-white p-2" src="public/v7.png"/>
    <img class="h-12 rounded bg-white p-2" src="public/hf.png"/>
    <img class="h-12 rounded bg-white p-2" src="public/roboflow.jpeg"/>
    <img class="h-12 rounded bg-white p-2" src="public/zurich.png"/>
  </div>
</div>
...
<div class="flex  gap-1 items-center justify-center" >
  <img class="h-80 rounded" src="public/bottlenecks.jpeg"/>
</div>
...
<div class="flex  gap-1 items-center justify-center mt-8" v-click>
  <img class="h-40 rounded" src="public/samsung_970.png"/>
</div>
...
<div class="flex items-center justify-center">
  <img class="h-100 rounded" src="public/virtual_memory_2.png"/>
</div>
...
<div class="flex items-center justify-center">
  <img class="h-100 rounded" src="public/virtual_memory_1.png"/>
</div>
...
<div class="flex items-center justify-center">
<img class="h-70 rounded" src="public/trace.png"/>
</div>
---
layout: default
---
...
<div class="flex  gap-1 items-center justify-center" >
  <img class="h-70 rounded" src="public/linkedin_pool.png"/>
</div>
...
<div class="flex  gap-1 items-center justify-center" >
  <img class="h-70 rounded" src="public/image_to_cuda_benchmark_batch_size_vs_time.png"/>
</div>
...
<div class="flex flex-col  gap-1 items-center justify-center">
  <div class="flex  gap-1 items-center justify-center">
    <img class="h-60 rounded" src="public/image_to_cuda_model_train_model-cuda_first_batch_size_vs_time_384-384.png"/>
    <img class="h-60 rounded" src="public/image_to_cuda_model_train_model-cuda_first_batch_size_vs_time_640-480.png"/>
  </div>
</div>
---
layout: default
...
<div class="flex flex-col  gap-1 items-center justify-center">
  <div class="flex  gap-1 items-center justify-center">
    <img class="h-80 rounded" src="public/image_to_cuda_model_train_model-cuda_first_batch_size_vs_time_1280-960.png"/>
  </div>
</div>
...
<div class="flex  gap-1 items-center justify-center mt-8">
  <img class="h-60 rounded" src="public/grogu.jpg"/>
  <img class="h-60 rounded" src="public/grogu_compressed.jpg"/>
</div>
...
<div class="flex  gap-1 items-center justify-center mt-8">
  <img class="h-80 rounded" src="public/compressed_vs_uncompressed_img_size-benchmark_batch_size_vs_time.png"/>
</div>
...
<div class="flex flex-col gap-1 items-center justify-center mt-8">
  <img class="h-30 rounded" src="public/memmap.png"/>
</div>
...
<div class="flex flex-col gap-1 items-center justify-center mt-8">
  <img class="h-80 rounded" src="public/image_to_cpu_benchmark-memmap-img_size_batch_size_vs_time.png"/>
</div>
...
<div class="flex flex-col gap-1 items-center justify-center mt-8">
  <img class="h-80 rounded" src="public/memmap_cuda_img_size-memmap_batch_size_vs_time.png"/>
</div>
...
<div class="flex flex-col gap-1 items-center justify-center h-full">
  <h1> Thank you 💜</h1>
  <img class="h-80 rounded" src="public/baby_yoda_happy.gif"/>
</div>