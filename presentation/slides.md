...
<div class="flex flex-col gap-1 items-center justify-center mt-20">
  <img class="h-40 rounded" src="/me.jpg"/>
  <div class="flex gap-8 items-center justify-center mt-4">
    <img class="h-12 rounded bg-white p-2" src="/pwc.png"/>
    <img class="h-12 rounded bg-white p-2" src="/v7.png"/>
    <img class="h-12 rounded bg-white p-2" src="/hf.png"/>
    <img class="h-12 rounded bg-white p-2" src="/roboflow.jpeg"/>
    <img class="h-12 rounded bg-white p-2" src="/zurich.png"/>
  </div>
</div>
...
<div class="flex  gap-1 items-center justify-center" >
  <img class="h-80 rounded" src="/bottlenecks.jpeg"/>
</div>
...
<div class="flex  gap-1 items-center justify-center mt-8" v-click>
  <img class="h-40 rounded" src="/samsung_970.png"/>
</div>
...
<div class="flex items-center justify-center">
  <img class="h-100 rounded" src="/virtual_memory_2.png"/>
</div>
...
<div class="flex items-center justify-center">
  <img class="h-100 rounded" src="/virtual_memory_1.png"/>
</div>
...
<div class="flex items-center justify-center">
<img class="h-70 rounded" src="/trace.png"/>
</div>
---
layout: default
---
...
<div class="flex  gap-1 items-center justify-center" >
  <img class="h-70 rounded" src="/linkedin_pool.png"/>
</div>
...
<div class="flex  gap-1 items-center justify-center" >
  <img class="h-70 rounded" src="/image_to_cuda_benchmark_batch_size_vs_time.png"/>
</div>
...
<div class="flex flex-col  gap-1 items-center justify-center">
  <div class="flex  gap-1 items-center justify-center">
    <img class="h-60 rounded" src="/image_to_cuda_model_train_model-cuda_first_batch_size_vs_time_384-384.png"/>
    <img class="h-60 rounded" src="/image_to_cuda_model_train_model-cuda_first_batch_size_vs_time_640-480.png"/>
  </div>
</div>
---
layout: default
...
<div class="flex flex-col  gap-1 items-center justify-center">
  <div class="flex  gap-1 items-center justify-center">
    <img class="h-80 rounded" src="/image_to_cuda_model_train_model-cuda_first_batch_size_vs_time_1280-960.png"/>
  </div>
</div>
...
<div class="flex  gap-1 items-center justify-center mt-8">
  <img class="h-60 rounded" src="/grogu.jpg"/>
  <img class="h-60 rounded" src="/grogu_compressed.jpg"/>
</div>
...
<div class="flex  gap-1 items-center justify-center mt-8">
  <img class="h-80 rounded" src="/compressed_vs_uncompressed_img_size-benchmark_batch_size_vs_time.png"/>
</div>
...
<div class="flex flex-col gap-1 items-center justify-center mt-8">
  <img class="h-30 rounded" src="/memmap.png"/>
</div>
...
<div class="flex flex-col gap-1 items-center justify-center mt-8">
  <img class="h-80 rounded" src="/image_to_cpu_benchmark-memmap-img_size_batch_size_vs_time.png"/>
</div>
...
<div class="flex flex-col gap-1 items-center justify-center mt-8">
  <img class="h-80 rounded" src="/memmap_cuda_img_size-memmap_batch_size_vs_time.png"/>
</div>
...
<div class="flex flex-col gap-1 items-center justify-center h-full">
  <h1> Thank you 💜</h1>
  <img class="h-80 rounded" src="/baby_yoda_happy.gif"/>
</div>